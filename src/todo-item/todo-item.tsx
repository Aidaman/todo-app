...
const TodoItem = (props: TodoItemProps): JSX.Element => (
  <div className="rounded-xl transition-all shadow-md px-8 flex sm:flex-col md:flex-row py-2 hover:shadow-lg ">
    ...
    <div className="sm:w-full md:w-fit flex gap-2 ml-auto sm:justify-center sm:align-bottom md:justify-end md:align-middle">
      {
